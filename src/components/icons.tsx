...
export function ClapperboardIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M6.2 5.3 8 10" />
      <path d="M11.5 3.8 13.3 8.5" />
      <path d="m4 12 .5 2H20l.5-2" />
...
export function SearchIcon({ className, strokeWidth = 1.5 }: IconProps & { strokeWidth?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className ?? cls}>
...
export function CloseIcon({ className, strokeWidth = 2.5 }: IconProps & { strokeWidth?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className ?? cls}>
...
export function MenuDotsIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 30 150"
      className={className ?? "h-7 w-[5.6px]"}
    >
      <g fill="var(--ink)">
...
export function EyeIcon({ className, crossed = false }: IconProps & { crossed?: boolean }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className ?? cls}>
